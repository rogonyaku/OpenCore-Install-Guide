# Углубленная отладка системы (на английском)
...
![](../../img/troubleshooting/kernel-debugging-md/serial-header.png)
...
<img width="508" alt="" src="../../img/troubleshooting/kernel-debugging-md/serial-connector.jpg">
...
| :--- | :--- |
| ![](../../img/troubleshooting/kernel-debugging-md/817DNdBZDkL._AC_SL1500_.jpg) | ![](../../img/troubleshooting/kernel-debugging-md/61yHczOwpTL._AC_SL1001_.jpg) |
...
![](../../img/troubleshooting/kernel-debugging-md/coolterm-first-start.png)
![](../../img/troubleshooting/kernel-debugging-md/coolterm-settings.png)
...
![CoolTerm Connect](../../img/troubleshooting/kernel-debugging-md/coolterm-connect.png)

To record, simply head to `Connections -> Capture to Text/Binary File -> Start...(Cmd+R)`:

![](../../img/troubleshooting/kernel-debugging-md/coolterm-record.png)
...
![](../../img/troubleshooting/kernel-debugging-md/more-downloads.png)
...
![](../../img/troubleshooting/kernel-debugging-md/kdk-install.png)

Once installed, you'll find the KDK components such as the debug kernel located at `/Library/Developer/KDKs`:

![](../../img/troubleshooting/kernel-debugging-md/kdk-installed.png)
