# Ноутбучные Clarksfield и Arrandale
...
| Примечание 2 | Многие платы Clarksfield и Arrandale не поддерживают UEFI |
...
![](../../img/config/config-legacy/acpi-arrendale.png)
...
* **Примечание**: Драйверы Apple Iron Lake поддерживают только дисплеи LVDS, но **не поддерживают** eDP
...
Безопасность сама за себя говорит, **не пропускайте этот раздел**. Мы изменим следующее:
...
| :--- | :--- | :--- | :--- |
| MacBookPro6,1 | Четырёхъядерный 45w(High End) | 17" |
| MacBookPro6,2 | Четырёхъядерный 45w(Low End) | 15" |
...
![](../../img/config/config-legacy/uefi-legacy-laptop.png)
