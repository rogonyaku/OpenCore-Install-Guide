...
![](../../img/config/config-legacy/laptop-sandy-igpu.png)
...
1. При первоначальной настройке config.plist укажите только `AAPL,snb-platform-id` - обычно этого достаточно

| AAPL,snb-platform-id | Type | Комментарии |
| ------------------- | ---- | ------- |
| **00000100** | Laptop | Для использования с ноутбуками |
| **10000300** | NUC | Для использования с Intel NUC |
...
* Серия HD 2000 также не поддерживается
...
На примере этого Sandy Bridge, мы выберем MacBookPro8,1 SMBIOS - это сделано намеренно для совместимости. Типичная разбивка выглядит следующим образом:

| SMBIOS | Тип процессора | Тип GPU | Размер дисплея |
| :--- | :--- | :--- | :--- |
| MacBookAir4,1 | Двухъядерный 17w | iGPU: HD 3000 | 11" |
| MacBookAir4,2 | Двухъядерный 17w | iGPU: HD 3000 | 13" |
| MacBookPro8,1 | Двухъядерный 35w | iGPU: HD 3000 | 13" |
| MacBookPro8,2 | Четырёхъядерный 45w(High End) | iGPU: HD 3000 + 6490M | 15" |
| MacBookPro8,3 | Четырёхъядерный 45w(High End) | iGPU: HD 3000 + 6750M | 17" |
| Macmini5,1 | Двухъядерный NUC | iGPU: HD 3000 | N/A |
| Macmini5,3 | Четырёхъядерный NUC | iGPU: HD 3000 | N/A |
