...
![ACPI](../../img/config/config-laptop.plist/icelake/acpi.png)
...
| **[SSDT-RHUB](https://dortania.github.io/Getting-Started-With-ACPI/)** | Требуется для исправления ошибок Root-device на многих ноутбуках Ice Lake |
...
![Booter](../../img/config/config-laptop.plist/icelake/booter.png)
...
![DeviceProperties](../../img/config/config-laptop.plist/icelake/DeviceProperties.png)
...
![PlatformInfo](../../img/config/config-laptop.plist/icelake/smbios.png)
...
| :--- | :--- | :--- | :--- | :--- |
| MacBookAir9,1 | Двух/Четырёхъядерный 12w | iGPU: G4/G7 | 13" | Есть |
| MacBookPro16,2 | Четырёхъядерный 28w | iGPU: G4/G7 | 13" | Есть |
