...
![ACPI](../../img/config/config-laptop.plist/broadwell/acpi.png)
...
![DeviceProperties](../../img/config/config-laptop.plist/broadwell/DeviceProperties.png)
...
![PlatformInfo](../../img/config/config-laptop.plist/broadwell/smbios.png)
