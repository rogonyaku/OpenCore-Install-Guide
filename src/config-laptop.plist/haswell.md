...
| Начало поддержки в macOS | OS X 10.8, Mountain Lion |
...
![ACPI](../../img/config/config-laptop.plist/haswell/acpi.png)
...
![DeviceProperties](../../img/config/config-laptop.plist/haswell/DeviceProperties.png)
...
| ------------------- | ---- | ------- |
| **0500260A** | Laptop | Обычно используется с HD5000, HD5100 и HD5200 |
| **0600260A** | Laptop | Обычно используется с HD4200, HD4400 и HD4600 вы **должны** использовать `device-id`(см. ниже) |
| **0300220D** | NUC | Обычно используется со всеми Haswell NUC, HD4200/4400/4600, вы **должны** использовать `device-id` (см. ниже) |

#### Примечания к конфигурации

В дополнение к `AAPL,ig-platform-id`, вы захотите добавить патч размера байта курсора с 6 МБ (00006000) до 9 МБ из-за некоторых сбоев:
...
**Специальное примечание для HD4200, HD4400 и HD4600**:

Вам также потребуется подменить device-id для поддержки:
...
![PlatformInfo](../../img/config/config-laptop.plist/haswell/smbios.png)

::: tip Информация

Для настройки SMBIOS, мы будем использовать приложение [GenSMBIOS](https://github.com/corpnewt/GenSMBIOS) от CorpNewt.

На примере этого Haswell, мы выберем MacBookPro11,1 SMBIOS. Типичная разбивка выглядит следующим образом:

| SMBIOS | Тип процессора | Тип GPU | Размер дисплея |
| :--- | :--- | :--- | :--- |
| MacBookAir6,1 | Двухъядерный 15w | iGPU: HD 5000 | 11" |
| MacBookAir6,2 | Двухъядерный 15w | iGPU: HD 5000 | 13" |
| MacBookPro11,1 | Двухъядерный 28w | iGPU: Iris 5100 | 13" |
| MacBookPro11,2 | Четырёхъядерный 45w | iGPU: Iris Pro 5200 | 15" |
| MacBookPro11,3 | Четырёхъядерный 45w | iGPU: Iris Pro 5200 + dGPU: GT750M | 15" |
| MacBookPro11,4 | Четырёхъядерный 45w | iGPU: Iris Pro 5200 | 15" |
| MacBookPro11,5 | Четырёхъядерный 45w | iGPU: Iris Pro 5200 + dGPU: R9 M370X | 15" |
| Macmini7,1 | Системы NUC | HD 5000/Iris 5100 | N/A |
