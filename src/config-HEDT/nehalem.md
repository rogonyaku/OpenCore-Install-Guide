# HEDT Nehalem и Westmere

| Поддержка | Версия |
| :--- | :--- |
| Поддерживаемая версия OpenCore | 0.6.8 |
| Начало поддержки в macOS | OS X 10.5.6, Leopard |
...
| Legacy | UEFI
| :--- | :--- |
| ![](../../img/config/config-legacy/booter-duetpkg.png) | ![](../../img/config/config-universal/aptio-iv-booter.png) |
...
Требуется для спуфинга (подмены) неподдерживаемых процессоров, к счастью, Nehalem официально поддерживается, поэтому патчинг не требуется.
...
На примере этого Nehalem, у нас есть несколько SMBIOS на выбор:

| SMBIOS | Оборудование |
| :--- | :--- |
| MacPro5,1 | Mojave и старее |
| MacPro6,1 | Catalina и новее |
