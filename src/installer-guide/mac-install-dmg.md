...
Ниже, установщики были извлечены с подлинных дисков восстановления Mac с удаленной блокировкой SMBIOS, содержимое самой OS X не было никаким образом модифицировано.
...
* [Восстановление через Дисковую Утилиту](#дисковая-утилита)
...
Это означает то, что SIP должен быть выключен, однако мы, вместо этого, рекомендуем использовать [Метод ASR](#asr).
