...
2. Вы должны видеть все разделы и диски. В нижней половине, вы видите ваши накопители. Найдите свой USB накопитель.
...
Далее, перейдите в корень USB накопителя и создайте папку с названием `com.apple.recovery.boot`. Дальше, переместите загруженные BaseSystem или RecoveryImage файлы. Пожалуйста, убедитесь, что вы скопировали файлы `.dmg` и `.chunklist` в эту папку:
