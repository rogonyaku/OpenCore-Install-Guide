# Настольные Haswell и Broadwell
...
![DeviceProperties](../../img/config/config.plist/haswell/DeviceProperties.png)
...
Добавлена ещё одна часть, которая показывает ненастоящий `device-id`, в случае, когда у вас есть неподдерживаемый в macOS HD 4400.
...
На примере этого Haswell, мы выберем iMac15,1 SMBIOS. Типичная разбивка выглядит следующим образом:

| SMBIOS | Оборудование |
| :--- | :--- |
| iMac14,4 | Haswell с только iGPU |
| iMac15,1 | Haswell с dGPU |
| iMac16,2 | Broadwell |
